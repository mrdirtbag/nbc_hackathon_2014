(function (root, factory) {
    ...
    templatizer["pages"]["settings"] = function tmpl_pages_settings() {
        return '<div data-hook="settings" class="settings"><div class="panel panel-default"><div class="panel-heading"><h1 class="panel-title">Settings</h1></div><div class="panel-body"><h2>John Smith</h2><h5>Hollywood, CA</h5></div><div class="panel-heading"><h2 class="panel-title">SOCIAL MEDIA</h2></div><div class="panel-body"><div class="panel-body"><img src="images/twitter-logo.png" height="40"/>  @JohnSmith</div><div class="panel-body"><img src="images/fb-logo.png" height="40"/>  /johnsmith</div></div><div class="panel-heading"><h2 class="panel-title">WATCH PREFERENCES</h2></div><div class="panel-body"><div class="container"><form role="form"><div class="row"><fieldset><div class="checkbox checkbox-circle"><label><input type="checkbox" value=""/>ALL</label></div><div class="checkbox checkbox-circle"><label><input type="checkbox" value=""/>Reference Episodes</label></div><div class="checkbox"><label><input type="checkbox" value=""/>Twitter</label></div><div class="checkbox"><label><input type="checkbox" value=""/>Facebook</label></div><div class="checkbox"><label><input type="checkbox" value=""/>Behind the Scenes</label></div><div class="checkbox"><label><input type="checkbox" value=""/>Videos</label></div><div class="checkbox"><label><input type="checkbox" value=""/>Photos</label></div><div class="checkbox"><label><input type="checkbox" value=""/>Comments</label></div></fieldset></div></form></div></div><a data-hook="done" role="button" class="btn btn-lg btn-primary">done</a></div></div>';
    };
