...
new Moonboots({
    moonboots: {
        jsFileName: 'feedline',
        cssFileName: 'feedline',
        main: fixPath('client/app.js'),
        developmentMode: config.isDev,
        libraries: [
        ],
        stylesheets: [
            fixPath('node_modules/bootstrap/dist/css/bootstrap.css'),
...
app.listen(PORT);
console.log("feedline is running at: http://localhost:" + PORT + " Yep. That\'s pretty awesome.");
